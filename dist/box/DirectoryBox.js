...
var DirectoryBox = /** @class */ (function (_super) {
    ...
    DirectoryBox.prototype.getBoxesAt = function (clientX, clientY) {
        return __awaiter(this, void 0, void 0, function () {
            var boxesAtPostion, i, box, clientRect;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < this.boxes.length)) return [3 /*break*/, 4];
                        box = this.boxes[i];
                        return [4 /*yield*/, box.getClientRect()]; // TODO: parallelize, getBoxesAt(..) is called often
                    case 2:
                        clientRect = _a.sent() // TODO: parallelize, getBoxesAt(..) is called often
                        ;
                    ...
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, boxesAtPostion];
                }
            });
        });
    };
